<template>
  <fieldset class="agenda-item-form">
    ...
    <ui-form-group :label="agendaItemTitleLabel">
...
export default {
  ...
  data() {
    return {
      ...
      agendaItemTitleLabel: 'Нестандартный текст (необязательно)',
    };
  },
  ...
  watch: {
    ...
    'localAgendaItem.type': {
      ...
      handler(value) {
        switch (value) {
          case 'talk':
            this.agendaItemTitleLabel = 'Тема';
            break;
          case 'other':
            this.agendaItemTitleLabel = 'Заголовок';
            break;
          default:
            this.agendaItemTitleLabel = 'Нестандартный текст (необязательно)';
            break;
        }
      },
    },
